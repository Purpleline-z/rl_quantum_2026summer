...
from project_file_locations import CODE_ROOT, IMAGE_REPRESENTATION_RESULTS_ROOT, resolve_data_root

HERE = Path(__file__).resolve().parent; DATA = resolve_data_root() / "original data"
OUT = IMAGE_REPRESENTATION_RESULTS_ROOT / "pca_tsne_dataset_exploration"; SEED = 42
...
def make_simclr_encoder(checkpoint: Path = CODE_ROOT / "classifier2" / "simclr_encoder_checkpoint" / "simclr_resnet18_encoder.pth"):
