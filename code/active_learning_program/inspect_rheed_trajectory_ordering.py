...
from project_file_locations import TRAJECTORY_ORDERING_RESULTS_ROOT, resolve_data_root
...
def run_audit(data_root: str | Path | None = None, output_root: Path | None = None) -> Path:
    ...
    output = output_root or (TRAJECTORY_ORDERING_RESULTS_ROOT / "temporal_constraint_audit")
