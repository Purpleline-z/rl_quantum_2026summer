...
from project_file_locations import CODE_ROOT, RESULT_ROOT, resolve_data_root
from pairwise_csv_loading_and_image_partitioning import dataset_spec, file_hashes, locate_input
ROOT = CODE_ROOT
...
from pair_acquisition_shared_calculations import core_set_select, pair_vector as cached_pair_vector, uncertainty_diversity_select
from image_metadata_and_symmetry_features import (SYMMETRY_MODES, fit_metadata_model, load_metadata,
...
class Experiment:
    def __init__(self, cfg: Config):
        ...
        self.encoder_weights = ROOT / "classifier2" / "simclr_encoder_checkpoint" / "simclr_resnet18_encoder.pth"
