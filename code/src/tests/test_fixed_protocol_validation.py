...
from selection_utils import aggregate_rows, core_set_select, robust_unit, uncertainty_diversity_select
from strategies import cluster_quota_uncertainty_sampling, cluster_margin_pairwise_sampling
from resumable_training import train_with_epoch_checkpoints
from run_fixed_protocol_validation import checkpointing_enabled
...
class FixedProtocolSelectionTests(unittest.TestCase):
    ...
    def test_cluster_quota_uses_each_cluster_before_fill(self):
        ...
        with patch("strategies.score_uncertainty", return_value=scored):
    ...
    def test_cluster_margin_starts_with_smallest_prefiltered_cluster(self):
        ...
        with patch("strategies.score_uncertainty", return_value=[{**x, "uncertainty": .5} for x in candidates]):
    ...
    def test_fifty_minute_policy_disables_checkpoint_writes(self):
        ...
        with TemporaryDirectory() as directory, patch("resumable_training.atomic_torch_save") as save:
    ...
    def test_one_hundred_twenty_one_minute_policy_enables_checkpointing(self):
        ...
        class Exp:
            ...
            def pairwise_accuracy(self, model, rows): return 1.0
        from tempfile import TemporaryDirectory
        with TemporaryDirectory() as directory, patch("active_learning_pipeline.PairRows", PairDataset), patch("resumable_training.atomic_torch_save") as save:
